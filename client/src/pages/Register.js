    ...
    return (
        <Box width={isNotMobile ? '40%' : '80%'} p={'2rem'} m={'2rem auto'} borderRadius={5} sx={{ boxShadow: 5 }} backgroundColor={theme.palette.background.alt}>
            ...
            <form onSubmit={handleSubmit}>
                <Typography variant='h3' textAlign={'center'} fontWeight={'bold'} color={'#1976D2'}>Sign Up</Typography>
                ...
                <Typography mt={2} textAlign={'center'}>Already have an account?<Link to='/login'>Please login</Link></Typography>
            </form>
        </Box>
    )
}
